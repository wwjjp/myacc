<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"D:\phpStudy\PHPTutorial\WWW\MyaccTh5./myaccount/report\view\paymentclassmonthtable\detail_list.html";i:1526542864;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="text-center">
    <div class="table-responsive work-div">
        <h3><?php echo $year; ?>年<?php echo $month; ?>月<?php echo $typename; ?>-<?php echo $classname; ?>分类汇总表</h3>
