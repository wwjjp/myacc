<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\phpStudy\PHPTutorial\WWW\MyaccTh5/myaccount/report\view\paymentdaychart\index_chart.html";i:1526569916;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
            ...
            <script>
                ...
                var myChart = new Chart(ctx, {
                    ...
                    options: {
                        ...
                        title: {
                            display: true,
                            text: '<?php echo $begindate; ?>至<?php echo $enddate; ?>的日收支统计图'            }
                    }
                });
            </script>
